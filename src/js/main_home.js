...
var src5=$(".s-slider__link")[4].getAttribute("data-src");
...
var photo=$(".s-slider__image");
var items=$(".s-slider__text-link");
...
btn_1.click(function(){
    ...
    $(items[0]).addClass('s-slider__text-link--active');
    $(photo).css('background-image','url("'+src1+'")');
